...
await page.goto(`${baseUrl}/app/gast/deine-auszeit/dev-active?code=MORROWDEV`, { waitUntil: 'networkidle' })
await page.getByText(/eure Auszeit ist vorbereitet/i).waitFor()
await page.getByRole('button', { name: 'Hilfe', exact: true }).click()
await page.getByText(/Schreibt uns, wenn ihr Orientierung braucht/).waitFor()
