...
| Live-Daten | Next-Guest ruft Open-Meteo fuer 14 Tage Wettervorschau ab und zeigt Heute/3 Tage/14 Tage mit Fallback; Gezeiten sind als Modul vorbereitet; Veranstaltungen werden aus kuratierten `local_places` nach Termin sortiert und im Vor-Ort-Bereich angezeigt | Live-Gezeitenquelle, Veranstaltungsdatenqualitaet und Fehlerzustand weiter ausbauen | MVP-light | Teilweise |
