...
3. Reisegruppe in Leads und Bookings: Erwachsene, Kinder, Kinderalter, Hund. Stand: fuer `leads` umgesetzt als `adults`, `children`, `children_ages` und `dog` mit Payload-Fallback; fuer `bookings` weiter offen.
